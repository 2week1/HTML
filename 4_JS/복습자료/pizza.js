function order(){
    ...
    const txtNode2 = document.createTextNode("토핑 : " + (selTopping.length == 0 ? '없음' : selTopping/*.join('/')*/));      // join : 배열에 있는 아이템들을 하나의 문자열로 반환
    ...
    liEle1.appendChild(txtNode1);       // appendChild : 추가하는 태그
